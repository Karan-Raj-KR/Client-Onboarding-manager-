...
var ClerkUI = class ClerkUI {
	...
	*/
	constructor(getClerk, getEnvironment, options, moduleManager) {
		...
		if (parsedVersion && !isVersionAtLeast(clerkVersion, "6.0.0")) incompatibilityMessage = `@clerk/ui@${ClerkUI.version} requires @clerk/clerk-js@>=${MIN_CLERK_JS_VERSION}, but found @clerk/clerk-js@${clerkVersion}. Please upgrade @clerk/clerk-js (or your framework SDK) to a compatible version.`;
