...
import { Badge, Box, Button, Col, Flex, Icon, Text } from "../../../../../../customizables/index.js";
import { handleError } from "../../../../../../utils/errorHandler.js";
import { Field } from "../../../../../../elements/FieldControl.js";
import { Form } from "../../../../../../elements/Form.js";
import { ActiveConnectionAlert } from "./ActiveConnectionAlert.js";
...
const IdentityProviderConfigurationForm = (config) => {
	return /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx(ConfigurationPanel, { ...config }), /* @__PURE__ */ jsx(ActiveConnectionAlert, {})] });
};
...
const buildSamlConfigurationPayload = async ({ mode, metadataUrl, metadataFile, manual }) => {
	...
	if (manual.certFile !== null) payload.idpCertificate = await manual.certFile.text();
	return payload;
};
