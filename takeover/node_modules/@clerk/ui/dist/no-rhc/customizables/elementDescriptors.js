...
const createElementDescriptor = (key) => {
	...
	return {
		...
		getObjectKeyWithState: (state) => objectKey + "__" + state,
		getObjectKeyWithId: (idObj) => objectKey + "__" + idObj.id,
		getObjectKeyWithIdAndState: (idObj, state) => objectKey + "__" + idObj.id + "__" + state,
		setId: (id) => id ? {
			id,
			__type: "id"
		} : void 0
